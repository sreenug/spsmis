function monthDataDisbursed(dropdown_value){
	...
	var bankloan_amt_grps = monthdata_filter_disbursed.map(function(d){return {
						location : d.location,
	...
	var bridgeloan_amt_grps = monthdata_filter_disbursed.map(function(d){return {
						location : d.location,
	...
	var specialloan_amt_grps = monthdata_filter_disbursed.map(function(d){return {
						location : d.location,
	...
	var bankloan_amt_member = monthdata_filter_disbursed.map(function(d){return {
						location : d.location,
	...
	var specialloan_amt_member = monthdata_filter_disbursed.map(function(d){return {
						location : d.location,
	...
	console.log(bankloan_amt_grps);
	console.log(bridgeloan_amt_grps);
	console.log(specialloan_amt_grps);
	console.log(bankloan_amt_member);
	console.log(specialloan_amt_member);
...
function monthDataRenderGroup(loan_data_group,label){
	...
	var svg = d3.select("#loan_container").append("svg")
...
function monthDataRenderMember(loan_data_member,label){
	...
	var svg_new = d3.select("#loan_container_new").append("svg")
					.attr("width",svg_width)
					.attr("height",svg_height)
					.attr("class","svg_new")
					.append("g");
...
function clickMarkMonth(data_new){
	...
	function clickMark(data_rect,label){
		...
		if (label == "groupdata"){
			var circle = d3.select("#loan_container").append("svg");
			var svg_rect = d3.select("#loan_container").append("svg");
		}
		else{
